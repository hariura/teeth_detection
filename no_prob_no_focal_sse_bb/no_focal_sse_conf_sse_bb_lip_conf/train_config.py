...
#         return global_steps.numpy(), optimizer.lr.numpy(), giou_loss.numpy(), conf_loss.numpy(), prob_loss.numpy(), total_loss.numpy()
        return global_steps.numpy(), optimizer.lr.numpy(), bb_loss.numpy(), conf_loss.numpy(), total_loss.numpy()
...
#         return giou_loss.numpy(), conf_loss.numpy(), prob_loss.numpy(), total_loss.numpy()
        return bb_loss.numpy(), conf_loss.numpy(), total_loss.numpy()
...
#                   .format(epoch, cur_step, steps_per_epoch, results[1], results[2], results[3], results[4], results[5]))
            print("epoch:{:2.0f} step:{:5.0f}/{}, lr:{:.6f}, bb_loss:{:7.2f}, conf_loss:{:7.2f}, total_loss:{:7.2f}"
                  .format(epoch, cur_step, steps_per_epoch, results[1], results[2], results[3], results[4])) #한칸 들어갔음
...
#         count, giou_val, conf_val, prob_val, total_val = 0., 0, 0, 0, 0
        count, bb_val, conf_val, total_val = 0., 0, 0, 0
...
#               format(giou_val/count, conf_val/count, prob_val/count, total_val/count))
        print("\n\nbb_val_loss:{:7.2f}, conf_val_loss:{:7.2f},total_val_loss:{:7.2f}\n\n".
              format(bb_val/count, conf_val/count, total_val/count))
