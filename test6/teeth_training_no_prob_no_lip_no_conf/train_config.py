...
#         return global_steps.numpy(), optimizer.lr.numpy(), giou_loss.numpy(), conf_loss.numpy(), prob_loss.numpy(), total_loss.numpy()
        return global_steps.numpy(), optimizer.lr.numpy(), giou_loss.numpy(), conf_loss.numpy(), total_loss.numpy()
...
#         return giou_loss.numpy(), conf_loss.numpy(), prob_loss.numpy(), total_loss.numpy()
        return giou_loss.numpy(), conf_loss.numpy(), total_loss.numpy()
...
#         count, giou_val, conf_val, prob_val, total_val = 0., 0, 0, 0, 0
        count, giou_val, conf_val, total_val = 0., 0, 0, 0
...
#               format(giou_val/count, conf_val/count, prob_val/count, total_val/count))
        print("\n\ngiou_val_loss:{:7.2f}, conf_val_loss:{:7.2f},total_val_loss:{:7.2f}\n\n".
              format(giou_val/count, conf_val/count, total_val/count))
